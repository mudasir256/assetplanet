        ...
        return (
            <React.Fragment>           
                ...
                <div className="top-btns-container">
                {
                    ...
                    <React.Fragment> 
                        <Button type="primary" onClick={() => this.fnToggleModal(MODAL.CLIENT_ADD)}>Add Client</Button>
                        <Button type="primary" onClick={() => this.fnToggleModal(MODAL.CLIENT_CHANGE)}>Change Client</Button>
                        <Button type="primary" onClick={() => this.fnToggleModal(MODAL.CLIENT_EDIT)}>Edit Client</Button>
                        <Button type="primary" onClick={() => this.fnToggleModal(MODAL.CLIENT_DELETE)}>Delete Client</Button>
                        ...
                        <Link to=""><Button type="primary">All My Clients</Button></Link>
                    </React.Fragment> 
                }
                </div>
                <Row gutter={16}>
...
export default connect(mapStateToProps, null)(ClientsPlans);