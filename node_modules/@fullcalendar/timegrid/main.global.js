    ...
    */
    ...
    function findNextLevelSegs(hierarchy, subjectLevel, subjectLateral) {
        ...
        for (; level < levelCnt; level += 1) {
            ...
            var entry = void 0;
            var searchIndex = common.binarySearch(entries, subjectEntry.spanStart, common.getEntrySpanEnd);
    ...
    var TimeCol = /** @class */ (function (_super) {
        ...
        function TimeCol() {
            ...
            _this.computeFgSegPlacements = common.memoize(computeFgSegPlacements); // only for non-print, non-mirror
            return _this;
        }
        TimeCol.prototype.render = function () {
            ...
            return (common.createElement(common.DayCellRoot, { elRef: props.elRef, date: props.date, dateProfile: props.dateProfile, todayRange: props.todayRange, extraHookProps: props.extraHookProps }, function (rootElRef, classNames, dataAttrs) { return (common.createElement("td", __assign({ ref: rootElRef, className: ['fc-timegrid-col'].concat(classNames, props.extraClassNames || []).join(' ') }, dataAttrs, props.extraDataAttrs),
                common.createElement("div", { className: "fc-timegrid-col-frame" },
                    ...
                    common.createElement("div", { className: "fc-timegrid-col-events" }, _this.renderFgSegs(sortedFgSegs, interactionAffectedInstances)),
        ...
        segIsInvisible, isDragging, isResizing, isDateSelecting) {
            ...
            return (common.createElement(common.Fragment, null,
                ...
                segRects.map(function (segRect) {
                    ...
                    return (common.createElement("div", { className: 'fc-timegrid-event-harness' + (segRect.stackForward > 0 ? ' fc-timegrid-event-harness-inset' : ''), key: instanceId, style: __assign({ visibility: segIsInvisible[instanceId] ? 'hidden' : '' }, positionCss) },
                        common.createElement(TimeColEvent, __assign({ seg: seg, isDragging: isDragging, isResizing: isResizing, isDateSelecting: isDateSelecting, isSelected: instanceId === eventSelection, isShort: (segRect.spanEnd - segRect.spanStart) < eventShortHeight }, common.getSegMeta(seg, todayRange, nowDate)))));
                })));
        };
        ...
        TimeCol.prototype.renderFillSegs = function (segs, fillType) {
            ...
            var children = segInputs.map(function (segInput) {
                ...
                return (common.createElement("div", { key: common.buildEventRangeKey(seg.eventRange), className: "fc-timegrid-bg-harness", style: _this.computeSegTopBottomCss(segInput) }, fillType === 'bg-event' ?
